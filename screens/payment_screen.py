...
class PaymentScreen(Screen):
    ...
    def setup_ui(self):
        ...
        self.input_date = TextInput(
            hint_text="Data (DD/MM/AAAA)", multiline=False, size_hint=(1, None), height=dp(50),
            background_color=(0.1, 0.1, 0.1, 1), foreground_color=(1, 1, 1, 1),
            hint_text_color=(0.5, 0.5, 0.5, 1)
        )
        self.input_client = TextInput(
            hint_text="Cliente", multiline=False, size_hint=(1, None), height=dp(50),
            background_color=(0.1, 0.1, 0.1, 1), foreground_color=(1, 1, 1, 1),
            hint_text_color=(0.5, 0.5, 0.5, 1)
        )
        self.input_value = TextInput(
            hint_text="Valor", input_filter="float", multiline=False, size_hint=(1, None), height=dp(50),
            background_color=(0.1, 0.1, 0.1, 1), foreground_color=(1, 1, 1, 1),
            hint_text_color=(0.5, 0.5, 0.5, 1)
        )
        self.input_description = TextInput(
            hint_text="Descrição", multiline=False, size_hint=(1, None), height=dp(50),
            background_color=(0.1, 0.1, 0.1, 1), foreground_color=(1, 1, 1, 1),
            hint_text_color=(0.5, 0.5, 0.5, 1)
        )
    ...
    def add_payment(self, instance):
        ...
        try:
            ...
            self.manager.get_screen('list_payments').load_payments()
